...
// ===================================================================REPLACE THIS STUFF===============================================================================
    if (fQMode == 2) {
        ...
        quartz_y = 111*mm/2; // 117.5 (open) ---> 152.5 (close)
        //Change quartz thickness here.
        quartz_z = 6*mm/2; // REPLACE END
    }
// ====================================================================================================================================================================
...
// QUARTZ AND TUNGSTEN PLACEMENT ===================================================================================================================================================
         ...
         = new G4PVPlacement(rotTung,G4ThreeVector(-6*mm/4,0,quartz_zPos-quartz_z-6*mm/2),tungsten_box_log,"tungsten", det_log,false,0); 

         G4VPhysicalVolume* tungsten_box_phys_2
         = new G4PVPlacement(rotTung,G4ThreeVector(-6*mm/4,0,quartz_zPos-3*quartz_z-3*6*mm/2),tungsten_box_log,"tungsten", det_log,false,0); 

         G4VPhysicalVolume* tungsten_box_phys_3
         = new G4PVPlacement(rotTung,G4ThreeVector(-6*mm/4,0,quartz_zPos-5*quartz_z-5*6*mm/2),tungsten_box_log,"tungsten", det_log,false,0);

         G4VPhysicalVolume* tungsten_box_phys_4
         = new G4PVPlacement(rotTung,G4ThreeVector(-6*mm/4,0,quartz_zPos-7*quartz_z-7*6*mm/2-0.5*mm),tungsten_box_log,"tungsten", det_log,false,0); // REPLACE END
//===============================
...
//
        ...
        G4Trap* mirror_box_1 = new G4Trap("mirror_box_1",74.27*mm/2,42*mm/2,0.5*mm/2,0.5*mm/2,58.13*mm/2); // Replaces lines 540-570
        ...
        G4Trap* mirror_box_2 = new G4Trap("mirror_box_2",70*mm/2,74.27*mm/2,0.5*mm/2,0.5*mm/2,211.5*mm/2);
        ...
        G4Trap* mirror_box_4 = new G4Trap("mirror_box_4",246*mm/2,246*mm/2,0.5*mm/2,0.5*mm/2,60.33*mm/2);
        ...
        G4Trap* mirror_box_6 = new G4Trap("mirror_box_6",68*mm/2,246*mm/2,0.5*mm/2,0.5*mm/2,191.88*mm/2);
...
// SUITCASE MIRROR DIMENSIONS =====================================================================================================================================================
        G4Box* mirror_box_7 = new G4Box("mirror_box_5",111*mm/2,0.5*mm/2,42*mm/2+1.0*mm); // Replaces lines 596-614 
        ...
        G4Box* mirror_box_8 = new G4Box("mirror_box_8",111*mm/2,246*mm/2,0.5*mm/2); 
        ...
        G4Box* mirror_box_9 = new G4Box("mirror_box_6",0.5*mm/2,246*mm/2,42*mm/2); // REPLACE END 
//======================================
...
//
        ...
        G4ThreeVector zTrans_1(86.07*mm,123*mm,-18*mm);
        ...
        G4ThreeVector zTrans_1_1(86.07*mm,-123*mm,-18*mm);
        ...
        rotM_2->rotateX(24.88*deg); 

        G4ThreeVector zTrans_2(211.07*mm,78.5*mm,-18*mm);
        ...
        rotM_2_1->rotateX(-24.88*deg); 

        G4ThreeVector zTrans_2_1(211.07*mm,-78.5*mm,-18*mm);
        ...
        G4ThreeVector zTrans_4(86.07*mm,0*mm,11.07*mm);
        ...
        G4ThreeVector zTrans_4_1(86.07*mm,0*mm,-47.07*mm);
        ...
        rotM_6->rotateX(-89.36*deg); 

        G4ThreeVector zTrans_6(211.07*mm,0*mm,18.07*mm);
        ...
        rotM_6_1->rotateX(-90.64*deg); 

        G4ThreeVector zTrans_6_1(211.07*mm,0*mm,-54.07*mm);
...
//=================================================================================================================================================================================
        G4ThreeVector zTrans_7(3*mm/2,123*mm+0.5*mm/2+0.01*mm,-18*mm); // Replaces lines 993-1034
        ...
        G4ThreeVector zTrans_7_1(3*mm/2,-123*mm-0.5*mm/2-0.01*mm,-18*mm);
        ...
        G4ThreeVector zTrans_8(3*mm/2,0.0*mm,6*mm/2+0.5*mm/2+0.01*mm);
        ...
        G4ThreeVector zTrans_8_1(3*mm/2,0.0*mm,-7*6*mm/2-3*6*mm-0.5*mm/2-0.01*mm);
        ...
        G4ThreeVector zTrans_9(-54*mm-0.5*mm/2-0.01*mm,0.0*mm,-18*mm); // END REPLACE
//=======================================
...
//===============================================================================================================================================================================
    rot_pmt -> rotateY(M_PI/2.*rad);
// PMT =============================================================================================================================================================================
        G4VPhysicalVolume* pmt_phys = new G4PVPlacement(rot_pmt,G4ThreeVector(307*mm+plngth,0.0*mm,-18*mm),pmt_log,"PMT",det_log,false,0); // Replaces lines 1046-1047 
        G4VPhysicalVolume* cath_phys = new G4PVPlacement(rot_pmt,G4ThreeVector(307*mm+plngth,0.0*mm,-18*mm),cath_log,"CATH",det_log,false,0); // REPLACE END
// PMT =============================================================================================================================================================================
        }

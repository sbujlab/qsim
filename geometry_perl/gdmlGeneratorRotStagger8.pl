...
print def "<box name=\"quartzCutSol1_${opt_T}_$j\" x=\"$dx[$j]\" y=\"$dy[$j]\" z=\"",$dx[$j]*(tan(abs($quartzCutAngle[$j]))),"\" lunit= \"mm\" />\n";

print def "<box name=\"quartzCutSol2_${opt_T}_$j\" x=\"",$dx[$j]/cos(abs($quartzCutAngle[$j])),"\" y=\"$dy[$j]\" z=\"",$dx[$j]/cos(abs($quartzCutAngle[$j])),"\" lunit= \"mm\" />\n";
=pod
print def "<subtraction name =\"quartzCutSol_${opt_T}_$j\">
	<first ref=\"quartzCutSol1_${opt_T}_$j\"/> 
	<second ref=\"quartzCutSol2_${opt_T}_$j\"/> 
	<position unit=\"mm\" name=\"quartzCutPos1_${opt_T}_$j\" x=\"",$dx[$j]*(0.5*tan(abs($quartzCutAngle[$j]))),"\" y=\"0\" z=\"",$dx[$j]*(0.5*tan(abs($quartzCutAngle[$j])))+$dx[$j]/2,"\"\/>
...
print def "<xtru name = \"quartzCutSol_${opt_T}_$j\" lunit= \"mm\" >
 <twoDimVertex x=\"0\" y=\"-30\" />
 <twoDimVertex x=\"0\" y=\"30\" />
 <twoDimVertex x=\"-30\" y=\"30\" />
 <section zOrder=\"1\" zPosition=\"-30\" xOffset=\"0\" yOffset=\"0\" scalingFactor=\"1\" />
 <section zOrder=\"2\" zPosition=\"30\" xOffset=\"0\" yOffset=\"0\" scalingFactor=\"1\" />
</xtru>\n";
...
print def "<subtraction name =\"refSol1_${opt_T}_$j\">
	...
	<second ref=\"quartzRecSol_${opt_T}_$j\"/> 
	<position unit=\"mm\" name=\"quartzCutPos1_${opt_T}_$j\" x=\"0\" y=\"0\" z=\"",$dzRef[$j]*(-0.5)+$dz[$j]*0.5,"\"\/>
        <rotation unit=\"rad\" name=\"quartzCutRot1_${opt_T}_$j\" x=\"0\" y=\"0\" z=\"0\"/>
</subtraction>\n\n";
...
=cut
print def "<physvol name=\"lg_${opt_T}_$j\">

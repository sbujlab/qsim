...
print def "<xtru name = \"lgLogicSol_${opt_T}_$j\" lunit= \"mm\" >
 <twoDimVertex x=\"",$dxLg[$j]*(0.5)+$width,"\" y=\"",$dzLg[$j]*0.5+$dxLg[$j]*tan($lgTiltAngle[$j])+$width*tan($lgTiltAngle[$j]),"\" />
 <twoDimVertex x=\"",$dxLg[$j]*(-0.5)-$width,"\" y=\"",$dzLg[$j]*(0.5)-$width*tan($lgTiltAngle[$j]),"\" />
 <twoDimVertex x=\"",$dxLg[$j]*(-0.5)-$width,"\" y=\"",$dzLg[$j]*(-0.5),"\" />
 <twoDimVertex x=\"",$dxLg[$j]*(0.5)+$width,"\" y=\"",$dzLg[$j]*(-0.5),"\" />
...
print def "<union name=\"quartzLogicSol_${opt_T}_$j\">
   ...
   <position name=\"quartzCutPos_${opt_T}_$j\" unit=\"mm\" x=\"",$dx[$j]*(0.5)+$dzRef[$j]*tan($refTopOpeningAngle[$j])-$dxLg[$j]/cos($lgTiltAngle[$j])+$dxLg[$j]*cos($lgTiltAngle[$j])/2-$dzLg[$j]*sin($lgTiltAngle[$j])/2,"\" y=\"0\" z=\"",$dzRef[$j]+$dz[$j]*(0.5)+$dzLg[$j]*cos($lgTiltAngle[$j])/2+$dxLg[$j]*sin($lgTiltAngle[$j])/2,"\"/>
    <rotation name=\"quartzCutRot_${opt_T}_$j\" unit=\"rad\" x=\"-pi/2\" y=\"",$lgTiltAngle[$j]*(-1),"\" z=\"0\"/> 
</union>\n";
...
print def "<xtru name = \"lgSol_${opt_T}_$j\" lunit= \"mm\" >
 <twoDimVertex x=\"",$dxLg[$j]*(0.5),"\" y=\"",$dzLg[$j]*0.5+$dxLg[$j]*tan($lgTiltAngle[$j]),"\" />
 <twoDimVertex x=\"",$dxLg[$j]*(-0.5),"\" y=\"",$dzLg[$j]*(0.5),"\" />
 <twoDimVertex x=\"",$dxLg[$j]*(-0.5),"\" y=\"",$dzLg[$j]*(-0.5),"\" />
 <twoDimVertex x=\"",$dxLg[$j]*(0.5),"\" y=\"",$dzLg[$j]*(-0.5),"\" />
...
print def "<volume name=\"quartzVol_${opt_T}\_$j\">
        ...
        <physvol name=\"lg_${opt_T}_$j\">
			...
			<rotation name=\"detectorRot_${opt_T}_$j\" unit=\"rad\" x=\"",pi/2,"\" y=\"",0,"\" z=\"",$lgTiltAngle[$j],"\"/>
</physvol> \n

...
void qsimDetectorConstruction::LGReflectivitySet(G4double ref = 0.9) {
...
//This was here before, but don't know what file qe.txt is.
//Also running macros/vis.mac while setting /gun/particle e- 
//would give an error "Photon Energy <= 0"
...
//This loop was commented out in the version from github on the brad_qsim branch
//Looks like this takes the last entry and swaps it with the first
//Swaps element (nEntries-1)-i with element i
//I don't understand why this is here so, I'll leave it commented out I guess...
/*	G4cout<<"set data";
	G4double temp;
...
*/		Efficiency4[i] = Efficiency4[i]/100.0;
        ...
        //LG
        Reflect_LG[i] = fLGReflectivity;//0.9; // Default to 0.9... maybe use Reflectivity3....
		...
		if(myfile.is_open()&&!myfile.eof()){
            G4cout<<"Using UVS_45Total.txt"<<G4endl;
			do{
